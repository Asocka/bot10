...
#--------------------------------
    ...
    #-----------------=Selesai=------------------
              ...
              if msg.from_ in admin:
                ...
                cl.sendMessage(msg)
                msg.contentMetadata = {'mid': 'ufac9ebbe9ad3afc807a5bd19873b3897'}
                ki.sendMessage(msg)
                msg.contentMetadata = {'mid': 'ufac9ebbe9ad3afc807a5bd19873b3897'}
                kk.sendMessage(msg)
                msg.contentMetadata = {'mid': 'ufac9ebbe9ad3afc807a5bd19873b3897'}
                ...
                msg.contentMetadata = {'mid': 'ufac9ebbe9ad3afc807a5bd19873b3897'}
                ka.sendMessage(msg)
                msg.contentMetadata = {'mid': 'u7207c19c75042665b566e9a48b7b7b4b'}
                kb.sendMessage(msg)
                msg.contentMetadata = {'mid': 'u7207c19c75042665b566e9a48b7b7b4b'}
                ko.sendMessage(msg)
                msg.contentMetadata = {'mid':'u7207c19c75042665b566e9a48b7b7b4b'}
                ke.sendMessage(msg)
                msg.contentMetadata = {'mid':'u022afccd453963aca320f2c36e8275b3'}
                ku.sendMessage(msg)
            elif msg.text in ["Me"]:
              if msg.from_ in admin:
                msg.contentType = 13
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"Team BOTTROX Mau Bersih² Group Sampah Nih")
                        ...
                        for target in targets:
                          if target not in Bots or owner:
                            if target in owner:
                              ...
                              try:
                                klist=[cl,ki,kk,kc,ks,ka,kb,ko,ke,ku]
                                kicker=random.choice(klist)
